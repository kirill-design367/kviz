...
export const QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    // Подписи нет намеренно. Прежняя обещала, что бюджет на расчёт не влияет,
    // — теперь это неправда: названная сумма подтягивает вилку вверх.
    // Объяснять это на экране незачем, а обманывать нельзя.
    options: [
