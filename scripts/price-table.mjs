...
console.log('Бюджет (вопрос 7) подтягивает вилку ВВЕРХ, если названная сумма выше расчёта.');
...
console.log('Бюджет двигает вилку ТОЛЬКО ВВЕРХ. Если названная сумма выше расчётного');
console.log('верха — вилка встаёт в границы названного бюджета. Если ниже — расчёт');
console.log('остаётся как есть: работа не может стоить дешевле того, что она стоит.\n');
const CASES = [
